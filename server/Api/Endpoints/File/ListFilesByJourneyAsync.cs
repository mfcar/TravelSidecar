...
{
    public static async Task<IResult> ListFilesByJourneyAsync(
        Guid journeyId,
        int? page,
        int? pageSize,
        string? searchTerm,
        ...
        CancellationToken ct)
    {
        ...
        var paginatedFiles = await fileService.GetFilesByJourneyAsync(
            journeyId, userId, queryParameters, type, category, ct);
