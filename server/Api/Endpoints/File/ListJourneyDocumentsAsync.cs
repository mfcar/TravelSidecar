...
{
    public static async Task<IResult> ListJourneyDocumentsAsync(
        Guid journeyId,
        int? page,
        int? pageSize,
        string? searchTerm,
        ...
        CancellationToken ct)
    {
        ...
        var paginatedFiles = await fileService.GetJourneyDocumentsAsync(journeyId, userId, queryParameters, ct);
